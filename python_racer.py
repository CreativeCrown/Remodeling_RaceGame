...
cars = CarsList()
cars.add(PlayerCar(400, 0, 0, 0, 10))
...
def main(): #メイン処理を行う関数
    ...
    while True: #無限ループ
        ...
        draw_text(screen, "lap {}/{}".format(laps[0], LAPS), 100, 30, WHITE, fnt_m)    #周回数を表示
        draw_text(screen, "time "+time_str(rec[0]), 100, 80, GREEN, fnt_s) #タイムを表示
